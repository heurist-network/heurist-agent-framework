...
| WanVideoGenAgent | Generate videos using Alibaba Wan 2.2 models. Supports text-to-video and image-to-video generation in 480p resolution. | • text_to_video<br>• image_to_video_plus<br>• image_to_video_flash<br>• get_video_status | [Source](./agents/wan_video_gen_agent.py) | DashScope |

...
| TrendingTokenAgent | Aggregates trending tokens from GMGN, CoinGecko, Pump.fun, Dexscreener, Zora and Twitter discussions. | • get_trending_tokens | [Source](./agents/trending_token_agent.py) | GMGN, CoinGecko, Dexscreener, Elfa, Zora |

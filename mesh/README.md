...
| TrendingTokenAgent | Aggregates trending tokens from GMGN, CoinGecko, Pump.fun, and social media intelligence sources. | • get_trending_tokens | [Source](./agents/trending_token_agent.py) | GMGN, CoinGecko, Bitquery, Elfa |
